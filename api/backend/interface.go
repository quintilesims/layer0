...
type Backend interface {
	CreateEnvironment(environmentName, instanceSize, operatingSystem, amiID string, minClusterCount, maxClusterCount, targetCapSize int, userData []byte) (*models.Environment, error)
