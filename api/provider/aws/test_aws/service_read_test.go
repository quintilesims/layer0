...
func TestServiceRead_loadBalancer(t *testing.T) {
...
func TestServiceRead_stateless(t *testing.T) {
	ctrl := gomock.NewController(t)
	defer ctrl.Finish()
...
func TestServiceRead_stateful(t *testing.T) {
	ctrl := gomock.NewController(t)
	defer ctrl.Finish()
	...
	service.SetPendingCount(int64(0))
	service.SetRunningCount(int64(1))
	service.SetLaunchType(ecs.LaunchTypeEc2)
	services := []*ecs.Service{
		service,
	}
...
func TestServiceRead_serviceNotFoundError(t *testing.T) {
	ctrl := gomock.NewController(t)
	defer ctrl.Finish()
