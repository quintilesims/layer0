...
func NewClusterManager(s ServiceLogic, t TaskLogic, d DeployLogic, j JobLogic) *ClusterManager {
...
func (c *ClusterManager) GetPendingResources(environmentID string) ([]resource.ResourceConsumer, error) {
...
func (c *ClusterManager) getPendingServiceResources(environmentID string) ([]resource.ResourceConsumer, error) {
...
func (c *ClusterManager) getPendingTaskResources(environmentID string) ([]resource.ResourceConsumer, error) {
...
func (c *ClusterManager) getPendingTaskResourcesInECS(environmentID string) ([]resource.ResourceConsumer, error) {
...
func (c *ClusterManager) getPendingTaskResourcesInJobs(environmentID string) ([]resource.ResourceConsumer, error) {
...
func (c *ClusterManager) getResourcesForDeploy(deployID string) ([]resource.ResourceConsumer, error) {
...
func (c *ClusterManager) GetResourceProviders(environmentID string) ([]*resource.ResourceProvider, error) {
	return nil, fmt.Errorf("get resource providers")
}

func (c *ClusterManager) MemoryPerProvider() bytesize.Bytesize {
	return 0
}

func (c *ClusterManager) ScaleTo(environmentID string, scale int, unusedProviders ...*resource.ResourceProvider) error {
	return fmt.Errorf("scale to not ipmlmeneted")
}
