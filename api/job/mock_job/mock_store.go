...
func (_m *MockStore) SetInsertHook(_param0 func(string)) {
	_m.ctrl.Call(_m, "SetInsertHook", _param0)
}

func (_mr *_MockStoreRecorder) SetInsertHook(arg0 interface{}) *gomock.Call {
	return _mr.mock.ctrl.RecordCall(_mr.mock, "SetInsertHook", arg0)
}
...
func (_m *MockStore) SetJobStatus(_param0 string, _param1 models.JobStatus) error {
